...
class StudentManagementSystem {
    students = new Map(); // Map is a collection of key-value pairs. Keys are unique. If you add a new entry with the same key, it updates the value for that key.
